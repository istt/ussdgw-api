package com.ft.config.timezone;

import com.ft.UssdApiApp;
import com.ft.repository.timezone.DateTimeWrapper;
import com.ft.repository.timezone.DateTimeWrapperRepository;
...
@SpringBootTest(classes = UssdApiApp.class)
